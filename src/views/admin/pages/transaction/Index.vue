    ...
    <div class="row">
      <div class="col-md-12 col-lg-12">
        <div class="row">
          <div class="col-md-7">
            <div class="col-auto">
              <create-action to_name="TransactionCreate" title="Transaction"/>
            </div>
          </div>
          <div class="col-md-5">
            ...
            <table class="table table-striped table-hover">
              ...
              <template v-if="lists.length">
                <tr v-for="(list, index) in lists">
                  ...
                  <td>{{ list.to_user ? list.to_user.name : '' }}</td>
                  <td>
                    Currency: {{ list.from_currency }}<br>
                    Amount: {{ list.from_amount | numberFormat }}
                  </td>
                  <td>
